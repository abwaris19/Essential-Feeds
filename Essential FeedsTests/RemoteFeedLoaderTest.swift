...
class RemoteFeedLoaderTest: XCTestCase {
    ...
    func test_load_deliversNoItemsOn200HTTPREsponseWithEmptyJSONList() {
      ...
      func test_load_deliversItemOn200HTPResponseWithJSONItems() {
            ...
            let (sut, client) = makeSUT()
            let item1 = makeItem(id: UUID(), imageURL: URL(string: "htpp://a-url.com")!)
            
      
            
            let item2 = makeItem(id: UUID(), description: "a desription", location: "a description", imageURL: URL(string: "http: //another-url.com")!)
    ...
    // MARK: - Helper
                 ...
                 private func makeSUT (url: URL = URL(string: "https://a-url.com")!, file: StaticString = #file, line: UInt = #line)  ->
    (sut: RemoteFeedLoader, client: HTTPClientSpy) {
        ...
        return (sut, client)
            ...
            addTeardownBlock { [weak instance] in
                XCTAssertNil(instance, "Instance should have been deallocated. Potenital memory leak.", file: file, line: line)
